...
`.withBehaviors(yn(gn`
            ...
            `)),shadowOptions:{delegatesFocus:!0}});var Ei;!function(t){t.separator="separator",t.presentation="presentation"}(Ei||(Ei={}));class Mi extends jt{constructor(){super(...arguments),this.role=Ei.separator}}W([_],Mi.prototype,"role",void 0);const Ri=Mi.compose({baseName:"divider",template:(t,e)=>Ue`
...
`,styles:(t,e)=>gn`
    ...
    `.withBehaviors(yn(gn`
            ...
            `)),indeterminateIndicator:'\n        <svg class="progress" part="progress" viewBox="0 0 16 16">\n            <circle\n                class="background"\n                part="background"\n                cx="8px"\n                cy="8px"\n                r="7px"\n            ></circle>\n            <circle\n                class="indeterminate-indicator-1"\n                part="indeterminate-indicator-1"\n                cx="8px"\n                cy="8px"\n                r="7px"\n            ></circle>\n        </svg>\n    '});class Ki extends jt{}const Qi=class extends Ki{connectedCallback(){super.connectedCallback();const t=Ut(this);t&&yr.setValueFor(this,(e=>Xr.getValueFor(e).evaluate(e,yr.getValueFor(t))))}}.compose({baseName:"card",baseClass:Ki,template:(t,e)=>Ue`
    <slot></slot>
`,styles:(t,e)=>gn`
        ${ci("block")} :host {
            --elevation: 4;
    ...
    `.withBehaviors(yn(gn`
            ...
            `))});class Zi extends jt{}W([_({mode:"boolean"})],Zi.prototype,"disabled",void 0);const Ji=Zi.compose({baseName:"tab",template:(t,e)=>Ue`
